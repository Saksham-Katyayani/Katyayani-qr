...
class _QcCheckPageState extends State<QcCheckPage> {
  ...
  Widget build(BuildContext context) {
    ...
    //     child: 
        Scaffold(
        appBar: AppBar(
            title: Text("Qc Check Page",style: TextStyle(fontSize: 18,fontFamily: "Sora-Regular",),),
                      ...
                      Navigator.push(
                          ...
                          new MaterialPageRoute(
                              builder: (context) => CustomContainerWidget(
                                    ...
                                    imageUrl: snapshot.data![index].images['inboundImage'],
                                  ))).then((value){
                                          setState(() {
                                            inBounds=getData("INBOUND");
                                          });
                                            ...
                                            child: Row(
                                              children: [
                                                Container(
                                                  height:100,
                                                  width: 100,
                                                  child:snapshot.data![index].images['inboundImage']!=null?Image.network(snapshot.data![index].images['inboundImage'].toString(),
