                    ...
                    columnWidths: widget.isTextFieldRequired
                        ? {
                            ...
                            2: FractionColumnWidth(
                                0.25), // Quantity column (increased width)
                        ...
                        : {
                            ...
                            2: FractionColumnWidth(
                                0.35), // Quantity column (increased width)
                            // Bin column
                          },
                            ...
                            ...widget.products.asMap().entries.map((entry) {
                              ...
                              return TableRow(children: [
                                TableCell(
                                  child: Container(
                                    height:
                                        80, // Set the height for each product row
                                    alignment: Alignment.center,
                                    child: Text("${index + 1}",
                                        textAlign: TextAlign.center),
                                  ),
                                ...
                                TableCell(
                                  child: Container(
                                    height: 80,
                                    alignment: Alignment.center,
                                    child: widget.isTextFieldRequired
                                        ? BinTextField(
                                            controller: binControllers[index])
                                        : Container(),
                                  ),
                                ),
                              ]);
                        ...
                        : [
                            TableRow(children: [
                              TableCell(
                                child: Container(
                                  height:
                                      80, // Set the height for the header row
                                  alignment: Alignment.center,
                          ...
                          for (int i = 0; i < widget.products.length; i++) {
                            if (binControllers[i].text.isEmpty) {
                              ScaffoldMessenger.of(context)
                                ...
                                content: Text(
                                  "Please enter a bin at S.No. $i and then submit",
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 18,
                                  ),
                              ...
                              bins.add(BinnerModel(
                                  sku: widget.products[i]['sku'],
                                  quantity: widget.products[i]['quantity'],
                                  Bin: binControllers[i]
                                      .text
                                      .toString()
                                      .toUpperCase()));
                            }
